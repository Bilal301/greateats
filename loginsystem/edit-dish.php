...
<body>
  ...
  <form class="m-5" method="POST">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="name" name="name" value="<?php echo $products['title']; ?>">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input type="number" step="0.01" class="form-control" id="price" name="price" value="<?php echo $products['price']; ?>">
    </div>
