    ...
    <div id="hero-carousel" class="carousel slide">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active c-item">
          <img src="./img/banner-burger.jpg" class="d-block w-100 c-img" alt="...">
        ...
        <div class="carousel-item c-item">
          <img src="./img/banner-kebab.jpg" class="d-block w-100 c-img" alt="...">
          <div class="carousel-caption top-0 d-none d-md-block">
        ...
        <div class="carousel-item c-item">
          <img src="./img/banner-pizza.jpg" class="d-block w-100 c-img" alt="...">
          <div class="carousel-caption top-0 d-none d-md-block">
            <h2>Italian Pizza</h2>
